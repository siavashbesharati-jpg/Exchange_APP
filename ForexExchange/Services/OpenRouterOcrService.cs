...
namespace ForexExchange.Services
{
    public class OpenRouterOcrService : IOcrService
    {
        ...
        {
            return @"لطفاً این تصویر رسید بانکی را تجزیه و تحلیل کنید و اطلاعات زیر را صندوق اج کنید:
...
اگر اطلاعاتی پیدا نکردید، مقدار null بگذارید.";
        ...
        {
            return @"لطفاً این تصویر گردش حساب بانکی را تجزیه و تحلیل کنید و اطلاعات زیر را صندوق اج کنید:
