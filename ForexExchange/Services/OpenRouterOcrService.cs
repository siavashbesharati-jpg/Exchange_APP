...
2. شماره تراکنش یا شماره پیگیری
3. تاریخ تراکنش
...
اگر اطلاعاتی پیدا نکردید، مقدار null بگذارید.";
        ...
        {
            return @"لطفاً این تصویر گردش حساب بانکی را تجزیه و تحلیل کنید و اطلاعات زیر را رسید  کنید:
  ...
  ""raw_text"": ""تمام متن قابل خواندن از تصویر""
        ...
        private OcrResult CreateMockOcrResult(string documentType)
        {
            ...
            if (documentType == "accounting_document")
            {
                ...
                {
                    Success = true,
                    RawText = "رسید تست - شماره تراکنش: 123456789 - مبلغ: 1,000,000 تومان - تاریخ: 1403/05/28",
                    Amount = "1000000",
